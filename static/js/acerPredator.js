...
//   ProductImg.style.width = '375px';
  ...
  Img[4].style.border = '1px solid black';
  Img[5].style.border = '1px solid black';
  Img[6].style.border = '2px solid black';
  Img[7].style.border = '1px solid black';
  Img[8].style.border = '1px solid black';
}
...
//   ProductImg.style.width = '375px';
  ...
  Img[4].style.border = '1px solid black';
  Img[5].style.border = '1px solid black';
  Img[6].style.border = '1px solid black';
  Img[7].style.border = '2px solid black';
  Img[8].style.border = '1px solid black';
}
...
//   ProductImg.style.width = '375px';
  ...
  Img[6].style.border = '1px solid black';
  Img[7].style.border = '1px solid black';
  Img[8].style.border = '2px solid black';
}
...
//   ProductImg.style.width = '375px';
  ...
  Img[7].style.border = '1px solid black';
  Img[8].style.border = '1px solid black';
  Img[9].style.border = '2px solid black';
}
